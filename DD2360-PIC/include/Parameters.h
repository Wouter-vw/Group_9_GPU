...
struct parameters {
  ...
  // This for maximum NS_MAX species. To have more increase the array size in
  // NS_MAX
  ...
  /** Field Boundary Condition
   0 =  Dirichlet Boundary Condition: specifies the valueto take pn the boundary
   of the domain 1 =  Neumann Boundary Condition: specifies the value of
   derivative to take on the boundary of the domain 2 =  Periodic Condition
   */

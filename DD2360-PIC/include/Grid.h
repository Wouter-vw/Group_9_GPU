 ...
 * nodes  */
void divSymmTensorN2C(FPinterp***, FPinterp***, FPinterp***, FPinterp***,
                      FPinterp***, FPinterp***, FPinterp***, FPinterp***,
                      FPinterp***, grid*);
...
void curlC2N(FPfield***, FPfield***, FPfield***, FPfield***, FPfield***,
             FPfield***, grid*);

/** calculate curl on central points, given a vector field defined on nodes  */
void curlN2C(FPfield***, FPfield***, FPfield***, FPfield***, FPfield***,
             FPfield***, grid*);
